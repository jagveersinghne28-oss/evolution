...
function Stat({ num, label }) {
  return (
    <div style={{ textAlign: "center" }}>
      <div style={{ fontSize: 32, fontWeight: 800, color: "#ffc107" }}>
        {num}
      </div>
...
export default function Home() {
  ...
  return (
    <div>
      <section style={{ background: "#fafafa", padding: "72px 0" }}>
        <div className="container" style={{ textAlign: "center" }}>
          ...
          <p style={{ color: "#6b7280", maxWidth: 720, margin: "18px auto" }}>
            Evolution Management Services connects top multilingual talent with
            leading organizations across India. Based in New Delhi, we
            specialize in building teams that drive success.
          </p>
          <div
            style={{
              display: "flex",
          ...
          >
            <Link to="/job-seekers" style={{ textDecoration: "none" }}>
      ...
      <section
        style={{ background: "#032b53", color: "#fff", padding: "28px 0" }}
      >
        <div
          className="container"
          style={{
            display: devicePrefix === "mobile" ? "" : "flex",
            justifyContent: "space-between",
            alignItems: "center",
          }}
        >
          <Stat num={`15+`} label="Years of Excellence" />
          <Stat num={`200000+`} label="Placements Made" />
      ...
      <section id="services" style={{ padding: "48px 0" }}>
        <div className="container" style={{ textAlign: "center" }}>
          ...
          <p style={{ color: "#6b7280" }}>
            Comprehensive HR solutions designed to meet your business needs.
          </p>
          ...
          >
            <div className="snapshot-card" style={{ textAlign: "left" }}>
              ...
              <p style={{ color: "#6b7280" }}>
                End-to-end talent acquisition across IT, Banking, Retail, and
                Hospitality sectors.
              </p>
            </div>
            <div className="snapshot-card" style={{ textAlign: "left" }}>
              ...
              <p style={{ color: "#6b7280" }}>
                Strategic HR solutions tailored to your organization's unique
                needs.
              </p>
            </div>
            <div className="snapshot-card" style={{ textAlign: "left" }}>
              <div className="icon-wrapper" style={{ padding: "9px" }}>
                <img
                  src={ICONS.security}
              ...
              <p style={{ color: "#6b7280" }}>
                Professional security personnel and management for businesses.
              </p>
            </div>
          </div>
      ...
      <section style={{ background: "#fbf6ee", padding: "36px 0" }}>
        <div className="container" style={{ textAlign: "center" }}>
          <h3 style={{ margin: 0, fontWeight: 700, fontSize: "2.25rem" }}>
            Industries We Serve
          </h3>
          <p style={{ color: "#6b7280" }}>
            Specialized recruitment expertise across key sectors
          </p>
          ...
          >
            {["IT & technology", "Banking & Finance", "Retail", "Security"].map(
              (t) => (
                <div
                  key={t}
                  style={{
                ...
                >
                  ...
                  />
                  <div
                    style={{ fontWeight: 700, color: "#082b51", marginTop: 6 }}
                  >
                    {t}
                  </div>
                </div>
